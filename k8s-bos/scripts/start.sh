...
cleos $remote transfer eosio voter "200000000.0000 BOS" "transfer 200M to voter"
sleep 2 ;
cleos $remote system delegatebw voter voter '100000000.0000 BOS' '100000000.0000 BOS' -p voter
...
do
    echo $acc
    cleos $remote system newaccount eosio $acc EOS54HgSQ9d6qjUT7pEZgbP83zQpcymR4QW1jz2jPDEdbAeKGaUif EOS54HgSQ9d6qjUT7pEZgbP83zQpcymR4QW1jz2jPDEdbAeKGaUif --stake-cpu "10 BOS" --stake-net "10 BOS" --buy-ram "10 BOS" -p eosio
    cleos $remote transfer eosio $acc "1000 BOS" "red packet" -p eosio
done
